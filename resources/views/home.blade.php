               ...
               <div class="row">
                  <form id="form" method="post" action="">
                     ...
                     <div class="col-md-4">
                        ...
                        <span class="input-group-addon" style="border-radius: 5px 0 0 5px"><i class="fa fa-calendar"></i></span><input type="date" class="form-control" style="border-radius: 0 5px 5px 0">
                        </div>
                     </div>
                     <div class="col-md-2"></div>
                  </form>
    ...
    <script>
        $(document).ready(function(){
            ...
            $.get(url, function(data){
                ...
                $('.wow').html('<option value="784">Kota Yogyakarta</option>'+city_opt);
            });
        });
    </script>
@endpush
